<?php 
	function send_email($email_recive,$name,$contents,$subject){
        ...
        $mail->Username   = "tuananhlg97@gmail.com"; // Tên đăng nhập tài khoản Gmail
        $mail->Password   = "Tuananh1997"; //Mật khẩu của gmail
        $mail->SetFrom($_POST['email'], $_POST['name']); // Thông tin người gửi
        $mail->AddReplyTo($_POST['email'],$_POST['name']);// Ấn định email sẽ nhận khi người dùng reply lại.
    ...
    $email_recive = "tuananhlg97@gmail.com";
    $name ="Tuan Anh";
    ob_start();
    // require("demo_email.html");
